    ...
    return (
        <section className="min-h-screen bg-[#150E28] text-[#F8F8F8] px-4 lg:px-0 pb-[150px] pt-[100px] overflow-x-hidden flex flex-col justify-center items-center">
            ...
            <div className="lg:w-[90%] mx-auto relative">
                ...
                <p className="mx-auto text-[1.05rem] leading-[1.7rem] text-center py-4 sm:w-[70%] lg:w-[40%] relative z-30">Getlinked Hackathon 1.0 is honored to have the following major companies as its partners and sponsors</p>

                <div className="circle absolute top-[20%] -left-[50%] lg:-left-[10%]"></div>

                <div className="circle absolute top-[60%] -right-[50%] lg:-right-[10%]"></div>

                <img src={smallStar} alt=" Star" className="absolute w-4 -top-[10%] lg:top-[20%] left-[50%] animate-pulse" />
                ...
                <img src={star} alt="Star" className="absolute w-4 top-[95%] animate-pulse left-[50%]" />
